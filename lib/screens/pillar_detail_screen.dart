...
class PillarDetails extends StatelessWidget {
  ...
  const PillarDetails({Key? key, required this.pillarHeaders, required this.imageUrl}) : super(key: key);
      ...
      body: Container(
        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                Image.asset(imageUrl,height: size.height * 0.25,width: size.width * 0.25,),
                Expanded(
